...
//         setMetrics(data)
//       } else {
//         setError(data.detail || "Failed to load metrics")
//       }
//     } catch {
...
//   return (
//     <div className="p-2">
//     {/* // <div className="min-h-screen bg-[#f0faf6] p-6">
//     //   <h1 className="text-lg font-bold text-[#1a3a32] mb-6">Financial Intelligence</h1> */}
