...
//   const lineColors = {
//     Base: { border: "#1D9E75", bg: "rgba(29,158,117,0.08)" },
//     Best: { border: "#3B82F6", bg: "rgba(59,130,246,0.08)" },
//     Worst: { border: "#E24B4A", bg: "rgba(226,75,74,0.08)" },
//   }
...
//       // Set date range bounds from first result
...
//   return (
//     <div className="bg-white/70 backdrop-blur border border-teal-100 rounded-2xl p-6 shadow-sm mt-6">
...
//         {/* Date range */}
//         <div className="flex flex-col gap-1">
//           <label className="text-xs text-gray-400 uppercase tracking-wide">Time Filter</label>
//           <div className="flex items-center gap-2">
//             <input type="date"
//               value={startDate}
//               min={dateRangeMin || undefined}
//               max={endDate}
//               onChange={e => setStartDate(e.target.value)}
//               className="text-xs border border-gray-200 rounded-lg px-2 py-1.5 text-gray-600 focus:outline-none focus:border-teal-400"/>
//             <span className="text-xs text-gray-400">→</span>
//             <input type="date"
//               value={endDate}
//               min={startDate}
//               max={dateRangeMax || undefined}
...
//             <div className="w-3 h-3 rounded-sm" style={{ background: lineColors[t].border }}/>
...
//       {loading && <p className="text-xs text-gray-400 mb-2">Loading chart...</p>}
//       <div style={{ position: "relative", height: "280px" }}>
//         <canvas ref={chartRef} role="img" aria-label="Financial snapshot line chart"/>
//       </div>

//       {/* Y axis label */}
//       <p className="text-xs text-gray-400 mt-3 text-center">{metricLabels[metricType]} ($) over time</p>
//     </div>
//   )
// }
